<template>
  <div class="dashboard-container">
    <el-card>
      <el-row :gutter="20">
        <el-col :span="6">  <el-input v-model="appId" placeholder="appId" /></el-col>
        <el-col :span="6">  <el-input v-model="aliveId" placeholder="aliveId" /></el-col>
